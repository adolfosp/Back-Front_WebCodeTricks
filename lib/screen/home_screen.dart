...
import 'package:webcodetricks/screen/addImage.dart';
    ...
    return Scaffold(
          ...
          child: BottomNavigationBar(
            ...
            items: [
              ...
              BottomNavigationBarItem(
                  ...
                  title: Text("Cad/ de Exercícios",
                      overflow: TextOverflow.visible,
                      textAlign: TextAlign.center)),
              BottomNavigationBarItem(
                  icon: Icon(Icons.picture_in_picture),
                  title: Text("Cad/ de Imagens",
                      overflow: TextOverflow.visible,
                      textAlign: TextAlign.center)),
              BottomNavigationBarItem(
                  icon: Icon(Icons.list),
        ...
        body: SafeArea(
          child: PageView(
            ...
            children: <Widget>[
              HomePageExercise(usuarioF: widget.usuario),
              AddExercise(usuarioF: widget.usuario),
              AddImage(usuarioF: widget.usuario),
              HomePageImage(usuarioAutor: widget.usuario),
              AlertDialog(
